...
struct SignInView: View {
    ...
    var viewModel = SignInViewModel(service: HomeNetworkingService(), authService: AuthenticationService())
    
    func login() async {
        if let response = await viewModel.login(email: email, password: password) {
